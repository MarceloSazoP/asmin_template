                  ...
                  <CarouselItem key={index} className="px-0 md:px-16 lg:px-28">
                    <div className="relative w-full pt-[66.66%]">
                      <img
                        src={image.src}
                        alt={image.alt}
                        className="absolute inset-0 size-full object-cove imagen"
                      />
                    </div>
                  </CarouselItem>
                ))}
...
export const GalleryDefaults: Props = {
  heading: "Instalaciones",
  description: "Descubre nuestro trabajo y compromiso con la calidad.",
  images: [
    {
