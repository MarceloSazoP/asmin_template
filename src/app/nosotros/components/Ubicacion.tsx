...
export type UbicacionProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Ubicacion = (props: UbicacionProps) => {
...
export const UbicacionDefaults: Props = {
  tagline: "Santiago, Región Metropolitana",
  heading: "Santiago, Lo Boza",
  description:
  ...
  contacts: [
    ...
    },
    {
      ...
      description: "Antillanca Sur N° 561",
    },
  ],
  map: {
